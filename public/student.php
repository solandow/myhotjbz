            ...
            <div class="container">   
                <div class="row">
                    <div class="blog-lst col-md-9">
                        <?php 
                        $type = $_GET['type'];
                        $get_post = mysqli_query($conn, "SELECT * FROM docs WHERE type = '$type' ORDER BY id DESC
                        
                        "); 
                        
                        if($type == 'Material'){
                            $newtype = 'GENERAL MATERIAL';
                        }else if($type == 'UTME'){
                            $newtype = 'UTME/JAMB Materials';
                        }else if($type == 'POST'){
                            $newtype = 'POST JAMB/UTME Materials';
                        }else if($type == 'int'){
                            $newtype = 'Interview Questions';
                        }else if($type == 'GMAT'){
                            $newtype = 'GMAT Questions';
                        }else{
                            echo "Not Applicable";
                        }
                        ...
                        <section class="post">
                            <div class="text-center padding-b-50">
                                <h2 class="animated"><a href=""><?php echo $row['title']; ?></a></h2>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="author-category">
                                       By <a href="#">Admin</a>
                                        in <a href="cate.php?job_cate=<?php echo $row['type']; ?>"><?php echo $newtype; ?></a>
                                    </p>
                                </div>
                                <div class="col-sm-6 right" >
                                    <p class="date-comments">
                                        <a href="#"><i class="fa fa-calendar-o"></i> <?php echo $row['date']; ?></a>
                                        <a href="#"><i class="fa fa-eye"></i> <?php echo $row['download']; ?> Downloads</a>
                                    </p>
                                </div>
                            </div>
                           <!-- <div class="image animated">
                            ...
                            <p class="intro"><?php echo $row['detail']; ?></p>
                            <p class="read-more">
                                <a href="down.php?id=<?php echo $row['id']; ?>" class="btn btn-default btn-border">Download</a>
                            </p>
                        </section>   
<?php } ?>
