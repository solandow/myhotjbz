            ...
            <div class="container">   
                <div class="row">
                    <div class="blog-lst col-md-9">
                        <?php 
                        $accro = $_GET['accro'];
                        $get_post = mysqli_query($conn, "SELECT * FROM docs WHERE type = '$accro' ORDER BY id DESC
                        ...
                        <section class="post">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="author-category">
                                       By <a href="#">Admin</a>
                                        in <a href="cate.php?job_cate=<?php echo $row['type']; ?>"><?php echo $row['type']; ?></a>
                                    </p>
                                </div>
                            ...
                            <p class="read-more">
                                <a href="doc/<?php echo $row['path']; ?>" class="btn btn-default btn-border">Download</a>
                            </p>
                        </section>   
<?php } ?>
