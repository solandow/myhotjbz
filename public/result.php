                ...
                <div class="row">
                    <div class="blog-lst col-md-9">
                        <?php 
                            ...
                            //echo "<script>alert('$job_title  $job_loc  $job_cate');</script>";
                            
                            
                            
                        //$job_cate = $_GET['job_cate'];
                        $get_post = mysqli_query($conn, "SELECT * FROM jobs WHERE job_title LIKE '%$job_title%' AND job_loc = '$job_loc' OR job_cate = '$job_cate'");
                        $count = mysqli_num_rows($get_post);
                        if($count == 0){
                            echo "Sorry We Couldn't find what you're looking for";
                        }else{
